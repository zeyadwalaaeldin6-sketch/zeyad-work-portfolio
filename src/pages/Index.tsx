...
const Index = () => {
  const { t, changeLanguage, isRTL, language } = useTranslation();
              ...
              <div className="flex flex-col items-center gap-4 pt-8">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                  ...
                  <Button 
                    ...
                    size="lg" 
                    className="bg-blue-600 hover:bg-blue-700 text-white shadow-glow hover:shadow-elegant transition-all duration-500 hover:scale-105"
                  >
